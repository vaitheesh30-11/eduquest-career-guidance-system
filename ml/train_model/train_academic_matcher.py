"""Train academic career matcher ML model."""
...
def train_academic_model(training_file, output_dir):
    trace_inputs = {
        "training_file": training_file,
        "output_dir": output_dir,
    }
    trace_metadata = {
        "model_family": "academic_matcher",
    ...
    with trace_block(
        ...
        try:
            ...
            categorical_cols = ["current_degree_field"]
            numeric_cols = [
                "gpa_percentile",
            ...
            pickle.dump(model, open(f"{output_dir}/academic_matcher_model.pkl", "wb"))
            pickle.dump(model, open(f"{output_dir}/academic_model.pkl", "wb"))
